              ...
              <div className="mt-6 p-4 rounded-xl bg-muted/50 border border-border">
                ...
                <div className="space-y-2 text-xs">
                  <div className="flex justify-between">
                    ...
                    <span className="text-foreground">alex@college.edu</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Faculty:</span>
                    <span className="text-foreground">sarah.faculty@college.edu</span>
                  </div>
                  <p className="text-center text-muted-foreground mt-2">(Any password works)</p>
                </div>
              </div>
            )}
          </div>
